...
describe("ValidateNote", () => {
  ...
  test("rejects an unknown schema", () => {
    const note = goodNote().replace("#+schema: zx-is-v2", "#+schema: zx-is-v3");
